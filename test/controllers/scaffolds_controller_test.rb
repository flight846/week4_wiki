...
class ScaffoldsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create scaffold" do
    assert_difference('Scaffold.count') do
      post scaffolds_url, params: { scaffold: { Article: @scaffold.Article, title: @scaffold.title } }
    end
  ...
  test "should update scaffold" do
    patch scaffold_url(@scaffold), params: { scaffold: { Article: @scaffold.Article, title: @scaffold.title } }
